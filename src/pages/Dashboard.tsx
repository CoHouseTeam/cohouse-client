      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="card bg-base-200 shadow-xl rounded-lg">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <a href="/tasks" className="btn btn-primary rounded-lg">바로가기</a>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-200 shadow-xl rounded-lg">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <a href="/settlements" className="btn btn-secondary rounded-lg">바로가기</a>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-200 shadow-xl rounded-lg">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <a href="/board" className="btn btn-accent rounded-lg">바로가기</a>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-200 shadow-xl rounded-lg">
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <a href="/mypage" className="btn btn-neutral rounded-lg">바로가기</a>
            </div>
          </div>
        </div>
      </div>
