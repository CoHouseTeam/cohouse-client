...
export const GROUP_ENDPOINTS = {
  ...
  MEMBER_DETAIL: (groupId: number, memberId: number) => `api/groups/${groupId}/members/${memberId}`,
  ...
  APPROVE_LEAVE: (groupId: number, requestId: number) => `api/groups/${groupId}/leave-requests/${requestId}`,
